...
const Menu = () => {
  return (
    <div className='menubar'>
      <Link className='menuitem' to='/anecdotes'>Anecdotes</Link>
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type='submit' className='form-button'>Create</button><button className='form-button' onClick={handleReset}>Reset</button>
      </form>
    </div>
  )
}
...
const App = () => {
  ...
  const handleNotificationChange = ({ msg, timer }) => {
    setNotification(msg)
    setTimeout(() => 
  ...
  const addNew = (anecdote) => {
    ...
    navigate('/')
    handleNotificationChange({ msg: `A new anecdote ${anecdote.content} created!`, timer: 5000 })
  }
